#-------------------------------------------------------------------------------
# Name:        py_currency_converter.py
# Purpose: A Currency Converter program, supports 160 currencies
#
# Author:      t8822_000
#
# Created:     14/02/2018
...
#importings: GUI, web services, etc.
import wx
import webbrowser
import configparser
...
class MainFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        # General constants
        self.PRODUCT = "py_currency_converter"
        self.VERSION = "0.0.1"
